...
import type { GetProps, StylableComponent, TamaguiElement, VariantSpreadExtras } from '@tamagui/core';
...
export type TabsVariantSpreadExtras<T extends StylableComponent> = VariantSpreadExtras<GetProps<T> & TabsContextType>;
