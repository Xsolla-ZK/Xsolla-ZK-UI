...
export interface DropdownContentTypeProps extends Omit<DropdownContentImplProps, 'disableOutsidePointerEvents'> {
    /** enable animation for content position changing */
    enableAnimationForPositionChange?: boolean;
}
export type DropdownContentProps = Omit<DropdownContentTypeProps, 'children'> & Omit<GetProps<typeof PopperContentFrame>, 'children'> & {
    children?: ReactNode;
};
export type DropdownContentImplProps = PopperContentProps & Omit<DismissableProps, 'onDismiss' | 'children' | 'onPointerDownCapture'> & {
    /**
