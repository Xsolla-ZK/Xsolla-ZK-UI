...
export interface NotificationImperativeOptions extends Omit<CreateNativeNotificationOptions, 'message'> {
    /**
...
type ShowOptions = CreateNativeNotificationOptions & CustomData & {
    /**
...
export {};
//# sourceMappingURL=notification-imperative.types.d.ts.map