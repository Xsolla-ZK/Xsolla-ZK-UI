...
export interface NotificationAnnounceProps extends Omit<GetProps<typeof VisuallyHidden>, 'children'>, NotificationScopedProps<{
    children: string[];
}> {
}
export {};
//# sourceMappingURL=notification-announce.types.d.ts.map