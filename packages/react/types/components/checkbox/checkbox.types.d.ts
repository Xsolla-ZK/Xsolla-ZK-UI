...
export type CheckboxVariantSpreadExtras<T extends StylableComponent> = VariantSpreadExtras<GetProps<T> & CheckboxContextType>;
...
export type CheckboxProps = CheckboxSharedProps & BoundProps<CheckboxExtraProps, 'onCheckedChange'> & {
