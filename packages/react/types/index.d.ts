...
declare const componentsTheme: {
    ...
    tabBarItemTitleTheme: <T extends Record<"light" | "dark", Record<string, string>>>(themes: T) => {
    ...
    tabBarItemIconTheme: <T extends Record<"light" | "dark", Record<string, string>>>(themes: T) => {
