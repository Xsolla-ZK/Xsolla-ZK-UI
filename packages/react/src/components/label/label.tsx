...
export const Label = LabelFrame.styleable<LabelProps>((props, forwardedRef) => {
      ...
      <LabelFrame
        ...
        onPress={(event) => {
          ...
          if (isWeb) {
            ...
            const isClickingControl = controlRef.current.contains(event.target as unknown as Node);
