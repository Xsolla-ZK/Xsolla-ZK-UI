import type { ToastImplFrame } from './toast-impl.styled';
...
export type ToastImplProps = ToastImplPrivateProps & ToastImplFrameProps & ToastExtraProps;

export type ToastProps = Omit<ToastImplProps, keyof ToastImplPrivateProps>;
