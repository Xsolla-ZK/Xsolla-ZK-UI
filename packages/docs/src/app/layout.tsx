        ...
        <span style={{ fontSize: 40 }}>
          ...
          >
            ...
            <path
              ...
              fill="#20DAFF"
            />
            <path d="M40.8473 37.0625H33.6071V29.7649H40.8473V37.0625Z" fill="#20DAFF" />
            <path d="M40.8473 37.0625H33.6071V29.7649H40.8473V37.0625Z" fill="#20DAFF" />
            <path d="M22.5203 37.0505H15.2366V29.7575H22.5203V37.0505Z" fill="#20DAFF" />
            <path d="M22.5203 37.0505H15.2366V29.7575H22.5203V37.0505Z" fill="#20DAFF" />
            <rect width="83" height="64" transform="translate(269.938)" fill="#20DAFF" />
            <path
